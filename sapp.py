...
with open('xgb_ft_model.pkl', 'rb') as f:
...
st.write(
    "This is a Multilingual Cyberbullying Detection model built to detect cyberbullying or hate speeches.\
     ...
     The Accuracy of this model is 95.02%, Precision is 94.90%, f1 score is 94.95% & recall score is 94.99%.")
